...
const HomeContent = {
  text: {
    ...
    description: "Welcome to your digital hub of information, connection, and empowerment. We are thrilled to introduce the official website of the Senior Citizens Association of Barangay San Antonio, a platform designed exclusively for you, our cherished members.",
    description1: "This website is a testament to our commitment to enhancing your quality of life, promoting community engagement, and ensuring that you have access to essential resources. Here, you'll find the latest news, announcements, and benefits that are tailored to your needs. Learn about the current officers and staff who work tirelessly for your well-being, and easily access application forms and requirements for the services you deserve.",
    description2: "We believe in the power of technology to bridge gaps and bring us closer. This website is more than just a digital space; it's an extension of the warm and vibrant community that is Barangay San Antonio. We invite you to explore, engage, and make the most of this platform that is designed with your comfort and preferences in mind.",
  },
  images: {
