...
const Teamitem = () => {
  return (
    ...
    <img className="rounded-xl group-hover:opacity-10" src="/assets/projects/Team.png" 
    alt="" />
    <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
      <h3 className="text-2xl text-gray-700 tracking-wider font-bold text-center">Senior Citizens' Team Building</h3>
