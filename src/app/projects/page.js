    ...
    return (
      ...
      <div className="max-w-[1240px] mx-auto px-4 py-8 md:py-16">
        <h2 className="text-xl lg:text-2xl tracking-wider font-bold uppercase text-blue-900 text-center">
          Services, Programs and Activties
        </h2>
        <p className="text-lg italic lg:text-xl font-light py-4 text-justify">
        ...
        <p className="text-lg italic lg:text-xl font-light py-4 text-justify">Our gallery is an open door, offering a glimpse into the very essence of our association. Here, you'll discover
          a harmonious fusion of services, programs, and activities, all meticulously corrdinated to work in harmony. Together,
