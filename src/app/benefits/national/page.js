        ...
        <div className="flex flex-1 justify-start items-center flex-col gap-6">
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="text-justify text-lg" style={isOpen ? null : paragraphStyles}>
                    ...
                    <h2 className='my-3 uppercase text-blue-950 font-semibold'>To access the Senir Citizen Discount for medical expenses in the Philippines, follow these steps:</h2>
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="text-justify text-lg" style={isOpen ? null : paragraphStyles}>
                    ...
                    cubic meteres of water, a 5% discount can be applied to both electric and water bills.

                    <h2 className='my-3 uppercase text-blue-950 font-semibold'>To access the Senir Citizen Discount on electric and utility bills, follow these steps:</h2>
                        <p>1. When makig payments at the closest payment center:</p>    
            ...
            <div className="w-full lg:w-1/2">
                ...
                <p className="text-justify text-lg" style={isOpen ? null : paragraphStyles}>
                    When taking your parents or grandparents out for a meal, it's essential to keep in mind that senior citizens in the Philippines are eligible for a 20% dicount at 
